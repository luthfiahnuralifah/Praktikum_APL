...
void tambahSiswa() {
    ...
    if (jumlahSiswa < MAX_SISWA) {
        ...
        getline(cin, dataSiswa[jumlahSiswa].nama); 
        cout << "Masukkan usia siswa : ";
        getline(cin, dataSiswa[jumlahSiswa].usia);
        cout << "Daftar Kelas :\n";
        cout << "[1] TK Dini\n";
        cout << "[2] TK A\n";
        cout << "[3] TK B\n";
        ...
        switch (pilihan) {
            case 1:
                dataSiswa[jumlahSiswa].kelas = "TK Dini";
                break;
            case 2:
                dataSiswa[jumlahSiswa].kelas = "TK A";
                break;
            case 3:
                dataSiswa[jumlahSiswa].kelas = "TK B";
                break;
            default:
...
void tampilkanSiswa() {
    ...
    for (int i = 0; i < jumlahSiswa; ++i) {
        cout << i + 1 << ". Nama: " << dataSiswa[i].nama << endl;
        cout << "   Usia: " << dataSiswa[i].usia << endl;
        cout << "   Kelas: " << dataSiswa[i].kelas << endl;
    }
    system("pause");
    system("cls");
}
